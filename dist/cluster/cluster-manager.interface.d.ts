...
export type ClusterManagerConfig = ClusterManagerDisabledConfig | ClusterManagerWorkerModeAutoConfig | ClusterManagerWorkerModeManualConfig;
export interface ClusterManagerProps {
    config: ClusterManagerConfig;
    startApplicationCallback: () => Promise<void>;
    stopApplicationCallback: () => Promise<void>;
}
//# sourceMappingURL=cluster-manager.interface.d.ts.map